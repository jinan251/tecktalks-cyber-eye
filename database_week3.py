...
#
#  Week 3: init_db() now also imports UserProfile so the table
#  is created automatically on server start.
# ============================================================
...
def init_db():
    ...
    """
    from db_models import User, UserProfile, ScanHistory  # noqa: F401
